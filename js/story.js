var storystring
document.body.style.background = "url(../image/new.jpg) no-repeat ";
...
function question(){
  var table = ["il reste 4 questions",
                      "il reste 4 questions",
                    "il reste 4 questions",
                     "il reste 4 questions",
                      "il reste 4 questions"];
  document.getElementsByName("").style.backgroundColor = table[i];
}
